...
echo -e "${BLUE}=================================================================${NC}"
echo -e "${BLUE}  common-kubernetes Test Suite - All Use Cases${NC}"
echo -e "${BLUE}=================================================================${NC}"
echo ""
...
# Run all test cases
run_test 1 "Deployment with HPA"
sleep 5

run_test 2 "Service + Ingress"
sleep 5

run_test 3 "ConfigMap/Secret Management"
sleep 5

run_test 4 "RBAC Setup"
...
if [ $UC_FAILED -eq 0 ]; then
  echo -e "${GREEN}✅ All common-kubernetes use cases passed!${NC}"
  exit 0
else
